    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
            <li class="nav-item active">
                <a class="nav-link" href="<?=base_url('product_list')?>">Ürün Listesi</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="<?=base_url('home/about')?>">Hakkımızda</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="<?=base_url('home/contact')?>">İletişim</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="<?=base_url('home/blogList')?>">Veriler</a>
            </li>
        </ul>
    </div>
</nav>
